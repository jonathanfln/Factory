...
@section('content_header')
    <h1>Éditer le skill "{{$skill->name}}"</h1>
@stop
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							@if($errors->has('name'))
							  ...
							  @endif
							<input type="text" name="name" id="name" class="form-control w-50 {{$errors->has('name')?'border-danger':''}}" placeholder="Veuillez entrer un skill" value="{{old('name', $skill->name)}}">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							...
							@endif
							<input type="text" name="logo" id="logo" class="form-control" placeholder="Veuillez entrez le code d'un logo" value="{{old('logo', $skill->logo)}}">
						</div>
					</div>
				</div>
			</div>
