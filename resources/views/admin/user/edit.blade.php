            ...
            <div class="box-body">
              ...
              <div class="col-md-6">
                <div class="form-group w-75">
                  ...
                  @endif
                  <input type="text" name="name" id="name" class="form-control {{$errors->has('name')?'bg-danger':''}}" placeholder="Nom de l'utilisateur" value="{{old('name', $user->name)}}">
                </div>
              </div>
              {{-- Fin nom --}}
              ...
              <div class="col-md-6">
                <div class="form-group w-75">
                  ...
                  @endif
                  <input type="email" class="form-control {{$errors->has('email')?'bg-danger':''}}" name="email" id="email" placeholder="adresse@email.com" value="{{old('email', $user->email)}}">
                </div>
              </div>
              {{-- Fin mail --}}
