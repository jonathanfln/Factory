  ...
  <div class="col-md-10">
    <div class="box w-75">
      ...
      <div class="box-body">
        ...
        <h3 class="">{{$testimonial->client->name}}</h3>
        <h4 class="">{{$testimonial->client->company}}</h4>
      </div>
      @endif
    </div>
  </div>
  <div class="col-md-2">
    <div class="box">
      ...
      <div class="box-body text-center">
        ...
        <form action="{{route('testimonials.destroy', ['testimonial'=>$testimonial->id])}}" method="post" class="visible-lg-inline-block">
          @csrf
          @method('DELETE')
